...
public class _455_assign_cookies {
	...
	public _455_assign_cookies() {
		System.out.println(findContentChildren(null, null)); // 0
		System.out.println(findContentChildren(new int[]{}, null)); // 0
		System.out.println(findContentChildren(null, new int[]{})); // 0
