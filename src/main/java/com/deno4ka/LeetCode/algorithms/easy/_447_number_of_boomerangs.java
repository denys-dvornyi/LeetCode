...
//						if (k == i || k == j) continue;
//						if (areBoomerangs(points[i], points[j], points[k])) {
//							numberOfBoomerangs++;
//						}
//					}
//				}
...
//	}
//
//	private boolean areBoomerangs(int[] first, int[] second, int[] third) {
////		System.out.println("first:" + Arrays.toString(first) + ", second:" + Arrays.toString(second) + ", third:" + Arrays.toString(third));
//		double firstDist = Math.sqrt(Math.pow((first[0] - second[0]), 2) + Math.pow((first[1] - second[1]), 2));
//		double secondDist = Math.sqrt(Math.pow((first[0] - third[0]), 2) + Math.pow((first[1] - third[1]), 2));
